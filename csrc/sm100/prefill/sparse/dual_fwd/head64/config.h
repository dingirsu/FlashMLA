...
// One 2-SM tile is formed by concatenating the 64 heads from two adjacent
// query tokens. CTA 0 owns token 2*p and CTA 1 owns token 2*p+1.
static constexpr int H_Q = 64;
static constexpr int B_H = 2*H_Q;
