...
def flash_mla_mxfp8_sparse_prefill(
    ...
    Args:
        ...
        d_v: int. The dimension of value vectors. Must be 512.
        attn_sink: optional, [h_q], float32.
        topk_length: optional, [s_q], int32.
...
def flash_mla_mxfp8_with_kvcache(
    ...
    Args:
        ...
        softmax_scale: float. Default to 1/sqrt(d_qk).
        attn_sink: optional, (num_heads_q,), float32.
        extra_k_cache: optional extra KV cache in same MXFP8 format.
        extra_indices_in_kvcache: optional, (batch_size, seq_len_q, extra_topk), int32.
        topk_length: optional, (batch_size,), int32.
        extra_topk_length: optional, (batch_size,), int32.

    Returns:
        out: (batch_size, seq_len_q, num_heads_q, head_dim_v), bfloat16.
